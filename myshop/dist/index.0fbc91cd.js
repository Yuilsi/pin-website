...
/* INTERACTION HEADER */ window.addEventListener("scroll", function() {
    var header = document.querySelector("header");
    header.classList.toggle("abajo", window.scrollY > 0);
});
/* MODAL LOGIN AND REGISTER */ const open = document.getElementById('open');
...
document.addEventListener('click', (event)=>{
    ...
    if (!isClickInsideModal && !isClickInsideButton) modal_container.classList.remove("open");
});
/* MENU HAMBURGER */ document.getElementById("btn_menu").addEventListener("click", mostrar_menu);
...
/* GRID OF IMAGES */ var elem = document.querySelector('.grid-container');
imagesLoaded(elem, ()=>{
...
},{}]},["k9TbP","fFaKF"], "fFaKF", "parcelRequirede3a")
